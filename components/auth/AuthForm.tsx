        ...
        <div className="px-5 pb-5 pt-4 sm:px-6 sm:pb-6">
          ...
          <form className="mt-5 space-y-4" onSubmit={onSubmit}>
            <label className="block">
              <span className="font-mono text-[11px] uppercase tracking-[0.14em] text-[var(--console-text-muted)]">Username</span>
              <Input
                type="text"
                value={username}
            ...
            {mode === "register" ? (
              <label className="block">
                <span className="font-mono text-[11px] uppercase tracking-[0.14em] text-[var(--console-text-muted)]">Confirm password</span>
                <div className="relative">
                  <Input
